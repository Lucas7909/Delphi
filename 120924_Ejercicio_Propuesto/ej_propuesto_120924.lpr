...
procedure buscar (vP:tVector;vBuscado:tBase;var cant:integer;var NDV:tVector);
var
  i:integer;
begin
cant:=0;
...
procedure mayorAlProm (vP:tVector;prom:real;var cant:integer;var NDV:tVector);
var
  i:integer;
begin
cant:=0;
